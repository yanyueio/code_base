...
$(() => {
  ...
  readTextFile("./data.json", function(text){
    ...
    var tmp_len=0;
    for(var i=0; i < year_len; i++){
      tmp_str = '<h2 class="milestone">' + data[i].year + '</h2>'
      tmp_str = tmp_str + '<h3>' + data[i].year_sum +'</h3><p>' + data[i].year_detail + '</p><p><ul>';
    ...
    console.log(document.getElementById("year_list"));
